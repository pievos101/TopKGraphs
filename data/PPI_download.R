...
disease = read.table("disgenet_v1.0/dhimmel-disgenet-a636cc0/data/consolidated.tsv",
                sep="\t", header=TRUE)

# Create the IGRAPH
library(igraph)
g <- graph_from_data_frame(PPI_990[,c("gene1","gene2")], directed=FALSE)
...
save(g_largest, file="PPI_990.RD")