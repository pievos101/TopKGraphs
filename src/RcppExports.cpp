...
// stationary_jaccard_walk_cpp
NumericVector stationary_jaccard_walk_cpp(List adj_list, int start_node, int max_iter, double tol, double eps);
RcppExport SEXP _TopKGraphs_stationary_jaccard_walk_cpp(SEXP adj_listSEXP, SEXP start_nodeSEXP, SEXP max_iterSEXP, SEXP tolSEXP, SEXP epsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List >::type adj_list(adj_listSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type eps(epsSEXP);
    rcpp_result_gen = Rcpp::wrap(stationary_jaccard_walk_cpp(adj_list, start_node, max_iter, tol, eps));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_TopKGraphs_stationary_jaccard_walk_cpp", (DL_FUNC) &_TopKGraphs_stationary_jaccard_walk_cpp, 5},
    {NULL, NULL, 0}
};
